...
$_['text_related_products']    = 'Похожая продукция и другие размеры';
$_['text_tax_product']         = 'Цена указана за шт с НДС (21%)';
$_['text_your_price']          = 'Ваша цена:';
$_['text_entity_price']               = 'цена';
$_['text_add_to_cart']               = 'Добавить в корзину';
$_['text_purchase']               = 'Приобрести образец';
$_['text_discount_before']            = 'От';
$_['text_discount_after']            = 'до';
$_['text_total']            = 'Всего: ';
$_['text_product_review']            = 'Отзывы о товаре';
