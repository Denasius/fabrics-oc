...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		// if (isset($this->request->post['config_category_title'])) {
		// 	$data['config_category_title'] = $this->request->post['config_category_title'];
		// } else {
		// 	$data['config_category_title'] = $this->config->get('config_category_title');
		// }

		// Социальные сети
		if (isset($this->request->post['config_social_1_title'])) {
			$data['config_social_1_title'] = $this->request->post['config_social_1_title'];
		} else {
			$data['config_social_1_title'] = $this->config->get('config_social_1_title');
		}

		if (isset($this->request->post['config_social_2_title'])) {
			$data['config_social_2_title'] = $this->request->post['config_social_2_title'];
		} else {
			$data['config_social_2_title'] = $this->config->get('config_social_2_title');
		}

		if (isset($this->request->post['config_social_3_title'])) {
			$data['config_social_3_title'] = $this->request->post['config_social_3_title'];
		} else {
			$data['config_social_3_title'] = $this->config->get('config_social_3_title');
		}

		if (isset($this->request->post['config_social_4_title'])) {
			$data['config_social_4_title'] = $this->request->post['config_social_4_title'];
		} else {
			$data['config_social_4_title'] = $this->config->get('config_social_4_title');
		}

		if (isset($this->request->post['config_social_5_title'])) {
			$data['config_social_5_title'] = $this->request->post['config_social_5_title'];
		} else {
			$data['config_social_5_title'] = $this->config->get('config_social_5_title');
		}

		// Ccылки на Социальные сети

		if (isset($this->request->post['config_social_1_link'])) {
			$data['config_social_1_link'] = $this->request->post['config_social_1_link'];
		} else {
			$data['config_social_1_link'] = $this->config->get('config_social_1_link');
		}

		if (isset($this->request->post['config_social_2_link'])) {
			$data['config_social_2_link'] = $this->request->post['config_social_2_link'];
		} else {
			$data['config_social_2_link'] = $this->config->get('config_social_2_link');
		}

		if (isset($this->request->post['config_social_3_link'])) {
			$data['config_social_3_link'] = $this->request->post['config_social_3_link'];
		} else {
			$data['config_social_3_link'] = $this->config->get('config_social_3_link');
		}

		if (isset($this->request->post['config_social_4_link'])) {
			$data['config_social_4_link'] = $this->request->post['config_social_4_link'];
		} else {
			$data['config_social_4_link'] = $this->config->get('config_social_4_link');
		}

		if (isset($this->request->post['config_social_5_link'])) {
			$data['config_social_5_link'] = $this->request->post['config_social_5_link'];
		} else {
			$data['config_social_5_link'] = $this->config->get('config_social_5_link');
		}

		if (isset($this->request->post['config_supplier_1'])) {
			$data['config_supplier_1'] = $this->request->post['config_supplier_1'];
		} else {
			$data['config_supplier_1'] = $this->config->get('config_supplier_1');
		}

		if (isset($this->request->post['config_supplier_2'])) {
			$data['config_supplier_2'] = $this->request->post['config_supplier_2'];
		} else {
			$data['config_supplier_2'] = $this->config->get('config_supplier_2');
		}

		if (isset($this->request->post['config_supplier_3'])) {
			$data['config_supplier_3'] = $this->request->post['config_supplier_3'];
		} else {
